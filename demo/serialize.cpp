...
int main(int argc, char* argv[])
{
    try
    {
        ...
        tntdb::Statement ins = db.prepare(
            "insert into myobjects(id, a, b)"
            " values (:id, :a, :b)");

        // create a object and fill with some data
        MyObject obj;
        obj.id = 42;
        obj.a = 1;
        obj.b = "Hello";

        // the operator<<= for tntdb::Statement and MyObject uses the serialization
